...
if __name__ == '__main__':
    ...
    p1 = ctx.Process(target=process1, name="Process 1", args=[name, count//2, 1], daemon=True)
    p2 = ctx.Process(target=process1, name="Process 2", args=[name, count//2, 2], daemon=True)
